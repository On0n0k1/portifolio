...
- **Experience** (reverse chronological):
  ...
  5. Web Developer (Freelance) — IT Services & Consulting, Divinópolis, Brazil (Remote) (Jan 2020–Dec 2021): Full-stack React/Node.js/Rust features for multiple clients; Rust services on GCP/AWS; WebAssembly for browser data processing; client-side JS bug fixes.
